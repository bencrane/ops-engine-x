...
This tool converts values between units of length, temperature, and weight. A user can ask "convert 100 kilometers to miles" or "what is 72 degrees F in Celsius," and Claude picks the right unit type and units from the request.
