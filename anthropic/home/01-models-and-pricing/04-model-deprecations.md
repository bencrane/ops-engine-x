...
1. Go to the Usage page in Console
...
- Regularly check the documentation for updates on model deprecations.
...
- Contact the support team if you need assistance with migration or have any questions.
