...
1. Upload files to Anthropic's secure storage and receive a unique `file_id`
2. Download files that are created from skills or the code execution tool
3. Reference files in Messages requests using the `file_id` instead of re-uploading content
4. Manage your files with list, retrieve, and delete operations
